...
- Performance (benchmark tables): 13.6 µs vs 58.3 µs for the torch
  advanced-indexing scatter on a 3060 (4.29x), 9.4 vs 20.9 µs on a
...
- The paged indirection costs ~1.09-1.10x over the contiguous op.
