...
| [Sampling and selection](sampling.md) | top-k / top-p / min-p / argmax, the fused samplers and decode steps (single-row and batched), the combined logit penalties, the same-token determinism guarantee |
